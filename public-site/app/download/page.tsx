  ...
  return (
    <main className="site-shell page-shell">
      ...
      <section className="page-hero" aria-labelledby="download-title">
        <p className="eyebrow">STANDALONE TEST BUILD · v0.1.014</p>
      ...
      <section className="download-card" aria-labelledby="package-title">
        <div>
          ...
          <h2 id="package-title">Flight Lab v0.1.014</h2>
          ...
          <a className="primary-action download-action" href="/downloads/flight-lab-pwa-v0.1.014.zip" download>
