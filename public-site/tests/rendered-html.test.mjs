...
test("the public site keeps the simulator asset and source history", async () => {
  ...
  await access(new URL("../public/downloads/flight-lab-pwa-v0.1.007.zip", import.meta.url));
  ...
  assert.match(downloadPage, /flight-lab-pwa-v0\.1\.007\.zip/);
  ...
  assert.match(changelog, /## v0\.1\.007/);
